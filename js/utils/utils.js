...
export class GameState {
    ...
    startNewGame(playerName) {
        ...
        // Initialize empty inventories and history logs
        ...
        // Defer market calculations to SimulationService after state is set
        this.setState({});
    }

    _getTierAvailability(tier) {
        // This is temporarily duplicated here for new game inventory seeding.
        // It's already in MarketService for replenishment logic.
        switch (tier) {
