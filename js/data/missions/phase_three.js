...
export const PHASE_THREE_MISSIONS = {
    ...
    'mission_33_guild': {
        ...
        isRepeatable: false,
        isAbandonable: false,
        description: "Transmission received and decrypted. The telemetry is highly... irregular. It outlines an unregistered anomaly of unprecedented scale orbiting between Mercury and the Sun.<br><br>Trajectory logs suggest this structure intercepted the materials launched from the Uranus station during the AI incident. This does not align with any sanctioned Guild operations. I am escalating this file for immediate, classified analysis.",
        triggers: [ 
    ...
    'mission_33_syndicate': {
        ...
        isRepeatable: false,
        isAbandonable: false,
        description: "Transmission verified. The Syndicate remembers loyalty, Captain [playerName], thank you.<br><br>This data is very interesting... The math points to a massive, unregistered mega-structure hiding near the Sun, catching covert supply lines like that anomalous shunt from Uranus. Anything the Guild can't regulate is an asset we can weaponize. The Syndicate has begun a deep investigation into the matter.",
        triggers: [ 
            { "type": "mission_completed", "missionId": "mission_32" },
    ...
    'mission_34_guild': {
        ...
        isRepeatable: false,
        isAbandonable: false,
        description: "Greetings, Captain. Audita forwarded your profile. I oversee the heavy transit operations. If you intend to continue contracting with the Guild, your hardware must match the environment.<br><br>The baseline requirement for this division is a minimum of one rank 3 system enhancement. Visit the tuning shop and purchase a rank 3 ship upgrade, then come and see me for work. Get it done.",
        ...
        completion: {
            ...
            text: "Your new hardward meets Guild compliance. I've verified the shipyard logs and your refit is approved and registered. Great work, it's a pragmatic upgrade. Surely now your ship will survive the strain we are about to put it through.",
    ...
    'mission_34_syndicate': {
        ...
        completion: {
            ...
            text: "That's a serious piece of hardware, nice work. This is a highly practical refit. It should serve you well in the work we have planned for you.",
            buttonText: "Acknowledge"
        },
        rewards: [
            { "type": "SET_FLAG", "flagId": "mission_34_complete", "value": true },
    ...
    'mission_35': {
        ...
        isRepeatable: false,
        isAbandonable: false,
        description: "Captain! I finally managed to hail you, <i>thank Sol</i>. My name is Myst, and I need immediate extraction.<br><br>When I was a child, my transport was caught in the radiation wake of a folded space drive. The fallout shredded my genetics, leaving me entirely dependent on heavy cybernetics to survive. But my hardware is turning on me.<br><br>It is intercepting a colossal, anomalous frequency echoing out from the Sun. Raw telemetry is flooding my thoughts, whispering about a scattered awareness coalescing. A golden joining. The data density is burning through my nervous system.<br><br>I need you to transport me to Dr. Droysia at Saturn's Clandestine Ring Station Medical Bay. She is performing an experimental gene therapy that can detach me from this nightmare. I will make it worth your while. Please, hurry.",
        ...
        completion: {
            ...
            title: "Safe Harbor",
            text: "We made it... Thank you, Captain.<br><br>Before I go under... take this key. This is my clearance for the <b>Kepler's Eye</b> observatory. I was training to be an astronomer before my condition worsened. The doctor has indicated my memories will be substantially altered... so I won't be needing the observatory anymore. It's yours now. It will open up their economy to your fleet. Again, thank you for the help, [playerName].",
    ...
    'mission_39_syndicate': {
        ...
        completion: {
            locationId: "any",
            title: "Impossible Anomaly",
            text: "Now that is a heavy asset. Good choice. But let's talk about this sensor ghost you just reported. My entire department is in shock. A Z-Class dreadnought? Using a Folded-Space Drive? You realize those drives are restricted, single-use tech that burns out massive amounts of energy to warp spacetime? We are looking at a complete myth flying through our sector. If someone is folding space out here, the game just changed completely. Keep your scanners tight, [playerName]. It's getting dark out there.",
            buttonText: "Understood"
        },
        rewards: [ { "type": "GRANT_UPGRADE", "upgradeId": "UPG_ENG_SPEED_2" } ]
    },
