/**
 * @file Contains the master database for all location-specific flavor text and ads
 * for the NewsTickerService. Replaces the old news_flavor.js.
 *
 * ES Module version: Exports a constant to be imported by other services.
 */
