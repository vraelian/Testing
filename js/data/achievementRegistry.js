...
export const ACHIEVEMENT_REGISTRY = [
    ...
    },
    {
        ...
        categoryId: 'Trading',
        title: 'Water Baron',
        description: (state) => `Sell 5,000 cumulative units of Water to Outer-Rim stations.`,
    ...
    },
    {
        ...
        description: (state) => `Net over 100,000 Credits in profit from a single transaction.`,
    ...
    // ---------------------------------------------------------
    {
        ...
        description: (state) => `Pay a cumulative total of 1,000,000 Credits in debt interest over your lifetime.`,
    ...
    },
    {
        ...
        categoryId: 'Finance',
        title: 'Credit Tycoon',
        description: (state) => `Hoard a liquid balance of 100,000,000 Credits.`,
    ...
    },
    {
        ...
        description: (state) => `Hoard a liquid balance of 1,000,000,000 Credits.`,
    ...
    },
    {
        ...
        description: (state) => `Execute 1,000 distinct commercial trades.`,
    ...
    },
    {
        ...
        categoryId: 'Fleet',
        title: 'Tech Hoarder',
        description: (state) => `Spend 5,000,000 Credits exclusively on hardware upgrades.`,
    ...
    },
    {
        ...
        description: (state) => `Spend 1,000,000 Credits purely on Starport hull repair services.`,
    ...
    // ---------------------------------------------------------
    {
        ...
        title: 'The Patron',
        description: (state) => state.player.unlockedLocationIds.includes('loc_sol') ? `Donate a cumulative 10,000 resource units to Sol Station progression caches.` : `Donate a cumulative 10,000 resource units to ${MASK} progression caches.`,
    ...
    },
    {
        ...
        description: (state) => `Play for a total of 50 in-game years (18,250 days).`,
    ...
    },
    {
        ...
        categoryId: 'Progression',
        title: 'Traveler',
        description: (state) => `Spend a cumulative total of 5,000 days in warp transit.`,
