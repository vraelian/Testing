...
export const DB = {
    ...
    COMMODITIES: [
        { id: COMMODITY_IDS.WATER_ICE, name: 'Water Ice', basePriceRange: [45, 55], tier: 1, unlockLevel: 1, styleClass: 'item-style-1', lore: 'Crude, unrefined water ice scraped from asteroids; a universal necessity.', canonicalAvailability: [0, 200], volatility: 0.02 },
        { id: COMMODITY_IDS.PLASTEEL, name: 'Plasteel', basePriceRange: [300, 375], tier: 1, unlockLevel: 1, styleClass: 'item-style-2', lore: 'A basic, versatile polymer for 3D printing and simple manufacturing.', canonicalAvailability: [0, 160], volatility: 0.03 },
        { id: COMMODITY_IDS.HYDROPONICS, name: 'Hydroponics', basePriceRange: [1900, 2400], tier: 2, unlockLevel: 1, styleClass: 'item-style-3', lore: 'Packaged agricultural systems and produce essential for feeding isolated colonies.', canonicalAvailability: [0, 90], volatility: 0.05 },
        { id: COMMODITY_IDS.CYBERNETICS, name: 'Cybernetics', basePriceRange: [4800, 6000], tier: 2, unlockLevel: 1, styleClass: 'item-style-4', lore: 'Mass-produced enhancement limbs and organs for the industrial workforce.', canonicalAvailability: [0, 80], volatility: 0.06 },
        { id: COMMODITY_IDS.PROPELLANT, name: 'Refined Propellant', basePriceRange: [13500, 17000], tier: 3, unlockLevel: 2, styleClass: 'item-style-5', lore: 'High-efficiency fuel that powers all modern ship drives.', canonicalAvailability: [0, 70], volatility: 0.04 },
        { id: COMMODITY_IDS.PROCESSORS, name: 'Neural Processors', basePriceRange: [32000, 40000], tier: 3, unlockLevel: 2, styleClass: 'item-style-6', lore: 'The silicon brains behind complex ship systems and station logistics.', canonicalAvailability: [0, 60], volatility: 0.08 },
        { id: COMMODITY_IDS.GMO_SEEDS, name: 'GMO Seed Cultures', basePriceRange: [75000, 95000], tier: 4, unlockLevel: 3, styleClass: 'item-style-7', lore: 'Patented seeds holding the key to unlocking agricultural wealth on new worlds.', canonicalAvailability: [0, 50], volatility: 0.12 },
        { id: COMMODITY_IDS.CRYO_PODS, name: 'Cryo-Sleep Pods', basePriceRange: [250000, 310000], tier: 4, unlockLevel: 3, styleClass: 'item-style-8', lore: 'Essential for long-haul passenger transport and colonization efforts.', canonicalAvailability: [0, 40], volatility: 0.07 },
        { id: COMMODITY_IDS.ATMO_PROCESSORS, name: 'Atmo Processors', basePriceRange: [900000, 1100000], tier: 5, unlockLevel: 4, styleClass: 'item-style-9', lore: 'Gargantuan machines that begin the centuries-long process of making a world breathable.', canonicalAvailability: [0, 30], volatility: 0.05 },
        { id: COMMODITY_IDS.CLONED_ORGANS, name: 'Cloned Organs', basePriceRange: [5000000, 6200000], tier: 5, unlockLevel: 4, styleClass: 'item-style-10', lore: 'Lab-grown replacements with high demand in wealthy core worlds; morally grey.', canonicalAvailability: [0, 20], volatility: 0.18 },
        { id: COMMODITY_IDS.XENO_GEOLOGICALS, name: 'Xeno-Geologicals', basePriceRange: [25000000, 31000000], tier: 6, unlockLevel: 5, styleClass: 'item-style-11', lore: 'Rare, non-terrestrial minerals with bizarre physical properties; a scientific treasure.', canonicalAvailability: [0, 15], volatility: 0.15 },
    ...
    TUTORIAL_DATA: {
        ...
        'intro_missions': {
            ...
            steps: [
                ...
                { "stepId": "mission_1_5", "text": "It's time for the maiden voyage of your new ship, the <b>{shipName}</b>!<br><br>Proceed to your <b>Ship Navigation</b> terminal and fly to the <b>Moon</b>.", "position": { "desktop": "bottom-center", "mobile": "top" }, "completion": { "type": "SCREEN_LOAD", "screenId": "navigation" }, "nextStepId": "mission_1_6", "isSkippable": false, "navLock": { "navId": "ship", "screenId": "navigation" } },
