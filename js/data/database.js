    ...
    TUTORIAL_DATA: {
        ...
        'intro_missions': {
            ...
            steps: [
                ...
                { "stepId": "mission_1_8", "text": "Mission complete! However, favors don't pay off <b class='hl-yellow font-bold'>Guild</b> loans.<br><br>Let's find a real <b class='hl-yellow font-bold'>profit margin.</b>", "position": { "desktop": "top-center", "mobile": "top" }, "completion": { "type": "INFO" }, "nextStepId": "mission_2_1", "isSkippable": false },
                ...
                { "stepId": "mission_2_1", "text": "The real money is in playing the markets yourself: <b>buying low and selling high</b>. Select the Starport to visit the <b>Moon</b> station's <b>Market</b>", "position": { "desktop": "top-center", "mobile": "top" }, "completion": { "type": "SCREEN_LOAD", "screenId": "market" }, "nextStepId": "mission_2_2", "isSkippable": false, "navLock": { "navId": "starport", "screenId": "market" } },
                { "stepId": "mission_2_2", "text": "This is the <b>Moon</b> Market. Observe the <b>MKT</b> indicator for plasteel - the market is paying <b>more than usual</b> for industrial goods. Selling your plasteel would be highly profitable! Do so now.", "position": { "desktop": "top-center", "mobile": "top" }, "completion": { "type": "INFO" }, "nextStepId": "mission_2_3", "isSkippable": false },
                ...
                { "stepId": "mission_2_4", "text": "This is the kind of contract you look for. Accept it, then go buy the Plasteel on Luna and deliver it to <b>Mars</b> to complete the mission.", "position": { "desktop": "bottom-right", "mobile": "top" }, "completion": { "type": "ACTION", "action": "complete-mission" }, "nextStepId": "mission_3_1", "isSkippable": false },
