...
export const DB = {
    ...
    // --- Sellable Materials Data ---
    MATERIALS: {
        'metal-scrap': {
            id: 'metal-scrap',
            name: 'Metal Scrap',
            description: 'Processed hull fragments and metallic debris. Can be sold to industrial processors for a flat rate.',
            sellValue: 1500
        }
    },
