...
export const DB = {
    ...
    COMMODITIES: [
        ...
        { id: COMMODITY_IDS.METAL_SCRAP, name: 'Metal Scrap', tier: 0, basePriceRange: [0, 0], volatility: 0, canonicalAvailability: [0, 0], styleClass: 'item-style-scrap', lore: 'A collection of salvaged hull fragments, micro-meteoric shrapnel, and miscellaneous alloys recovered from ship repairs. It is non-tradable but can be recycled at any starport for credits.', cat: 'MAT', symbol: 'SCRP', isNonTradable: true } // Added for Metal Update
    ],
