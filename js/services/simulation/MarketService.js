...
export class MarketService {
    ...
    getPrice(locationId, commodityId, applyModifiers = false) {
        ...
        if (applyModifiers && state.player.activeShipId) {
            // Note: We only apply 'buy' modifiers here for general price display.
            // 'Sell' modifiers are context-dependent (cargo age) and usually handled by the seller.
            const mod = GameAttributes.getPriceModifier(state.player.activeShipId, locationId, 'buy', { commodityId });
