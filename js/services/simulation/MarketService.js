...
import { MarketService } from './services/simulation/MarketService.js'; // Import MarketService
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function startGame(playerName) {
        ...
        const marketService = new MarketService(gameState); // Instantiate MarketService
        const simulationService = new SimulationService(gameState, uiManager, marketService); // Inject MarketService
        ...
        if (!hasSave) {
            simulationService.startNewGame(playerName); // Use SimulationService to start
        }
