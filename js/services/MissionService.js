...
export class SimulationService {
    ...
    buyItem(goodId, quantity) {
        ...
        if (quantity > marketStock) { this.uiManager.queueModal('event-modal', "Limited Stock", `This station only has ${marketStock} units available.`);
        return false; }
        ...
        if (state.player.credits < totalCost) { this.uiManager.queueModal('event-modal', "Insufficient Funds", "Your credit balance is too low.");
        return false; }
        ...
        if (this.missionService) { this.missionService.checkTriggers(); }
     ...
     * into a single transaction log entry.
     * This prevents spamming the finance log
