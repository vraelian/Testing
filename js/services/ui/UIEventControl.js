...
export class UIEventControl {
    ...
    async playActIntermissionSequence(missionId, config, callback) {
        ...
        promptTitle.style.fontFamily = '"Aldrich", sans-serif';
        promptTitle.textContent = config.actLabel || 'ACT';

        const startBtn = document.createElement('button');
        startBtn.className = 'btn px-8 py-3 text-lg font-bold w-1/2 transition-colors duration-300';
        ...
        if (missionId === 'mission_tutorial_01') { // Act 0: Deep Space Blue -> Obsidian -> Amber
            ...
            // Thematic Button: Blue/Orange
            startBtn.style.color = '#fbbf24'; // Amber
            startBtn.style.border = '1px solid #38bdf8'; // Cyan
            startBtn.style.backgroundColor = 'rgba(15, 23, 42, 0.8)'; // Dark Slate
            startBtn.style.boxShadow = '0 0 15px rgba(56, 189, 248, 0.4), inset 0 0 10px rgba(56, 189, 248, 0.2)';
            startBtn.onmouseover = () => { startBtn.style.backgroundColor = 'rgba(15, 23, 42, 1)'; startBtn.style.boxShadow = '0 0 20px rgba(56, 189, 248, 0.6)'; };
            startBtn.onmouseout = () => { startBtn.style.backgroundColor = 'rgba(15, 23, 42, 0.8)'; startBtn.style.boxShadow = '0 0 15px rgba(56, 189, 248, 0.4), inset 0 0 10px rgba(56, 189, 248, 0.2)'; };
            ...
            // Thematic Button: Gold/White
            startBtn.style.color = '#111827'; // Dark text
            startBtn.style.border = '1px solid #ffffff'; // White border
            startBtn.style.backgroundColor = 'rgba(253, 224, 71, 0.8)'; // Bright Gold
            startBtn.style.boxShadow = '0 0 15px rgba(255, 255, 255, 0.5), inset 0 0 10px rgba(255, 255, 255, 0.3)';
            startBtn.onmouseover = () => { startBtn.style.backgroundColor = 'rgba(253, 224, 71, 1)'; startBtn.style.boxShadow = '0 0 20px rgba(255, 255, 255, 0.8)'; };
            startBtn.onmouseout = () => { startBtn.style.backgroundColor = 'rgba(253, 224, 71, 0.8)'; startBtn.style.boxShadow = '0 0 15px rgba(255, 255, 255, 0.5), inset 0 0 10px rgba(255, 255, 255, 0.3)'; };
            ...
            // Thematic Button: Violet/Orange
            startBtn.style.color = '#ea580c'; // Orange
            startBtn.style.border = '1px solid #a855f7'; // Purple border
            startBtn.style.backgroundColor = 'rgba(46, 16, 101, 0.8)'; // Deep Violet
            startBtn.style.boxShadow = '0 0 15px rgba(168, 85, 247, 0.5), inset 0 0 10px rgba(168, 85, 247, 0.3)';
