    ...
    renderFinanceScreen(gameState) {
        ...
        if (player.debt > 0) {
            ...
            loanHtml = `
               ...
               <button data-action="${ACTION_IDS.PAY_DEBT}" class="btn w-full py-3 bg-red-800/80 hover:bg-red-700/80 border-red-500" ${player.credits >= player.debt ? 'disabled' : 'disabled'}>
                   Pay Off Full Amount
               </button>
        ...
        const animationLoop = (currentTime) => {
            ...
            if (progress < 1) {
                ...
                if (totalHullDamagePercent > 0.01) {
                    ...
                    if (this.isMobile) {
                        infoText.innerHTML += hullDamageText.outerHTML;
                    }
                } else {
